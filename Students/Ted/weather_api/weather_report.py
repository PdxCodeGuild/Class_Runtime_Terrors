...
class Mico:
    ...
    def current(self):
        current = requests.get(f'https://api.openweathermap.org/data/2.5/weather?lat={self.location[1]}&lon={self.location[2]}&units=imperial&appid=8af2aa7fa978da0c3dc608a85406875c')
        data = current.json()
