...
def main():
    ...
    print('''We will exchange today's USD for British Sterling of the
     Regency Era - 1811 to 1820 AD. Note that modern dollars are worth
     0.0125 pounds, so please bring a fist-full if you mean to enjoy
     your visit here.\n  
    ''')
    ...
    while not endgame: 
        ...
        x = float(x)
        x = x * 0.77 # converts from 2019 USD to 2019 GBP
